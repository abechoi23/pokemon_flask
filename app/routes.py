...
def poke_api_call():
    ...
    return render_template('index.jinja', pokemon_name=pokemon_name, pokemon_type=pokemon_type, pokemon_weight=pokemon_weight, pokemon_image=pokemon_image, pokemon_abilities=pokemon_abilities, form=form)
